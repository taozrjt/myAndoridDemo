...
/**
 * Created by ${zrjt} on 2015/9/21.
 */
public class WeixinMenuView extends ViewGroup implements View.OnClickListener{
    ...
    public WeixinMenuView(Context context) {
        this(context, null);
        // TODO Auto-generated constructor stub
    }
    public WeixinMenuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        // TODO Auto-generated constructor stub
    }
    public WeixinMenuView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
        //获取自定义属性
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.WeixinMenuView,defStyle,0);
        int pos = a.getInt(R.styleable.WeixinMenuView_position  , POS_RIGHT_BOTTOM);
        switch (pos) {
            case POS_LEFT_TOP:
        ...
        mRadius = (int) a.getDimension(R.styleable.WeixinMenuView_radius,
